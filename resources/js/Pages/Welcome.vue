<template>
   <div class="container">
    <div class="images">
        <div class="_hl"></div>
        <div class="_tech">
            <img src="storage/images/tech-software-developer.webp" alt="Blue tech software abstract shapes">
            <img src="storage/images/web-software-developer.webp" alt="Neon tech software computer part">
        ...
        <div class="dark-bg">
            <div class="_socials">
                <a href="https://github.com/striderwhite" target="_blank"><i class="fa-brands fa-github-alt"></i></a>
                <a href="https://www.linkedin.com/in/striderwhite/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a>
                <a href="https://open.spotify.com/artist/3bVGm4gbJWtaVmatdJHEUB" target="_blank"><i class="fa-brands fa-spotify"></i></a>
                <a href="https://soundcloud.com/strider_white" target="_blank"><i class="fa-brands fa-soundcloud"></i></a>
            </div>
        </div>
    </div>
    <div class="content">
